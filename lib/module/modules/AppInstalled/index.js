...
const InstalledAppModule = isTurboModuleEnabled ? Platform.OS === 'android' ? require('./NativeInstalledApp').default : undefined : NativeModules.InstalledApp;
...
export async function isAppInstalled(deepLink, packageName) {
  try {
