...
var _DataUtil = _interopRequireDefault(require("../utils/DataUtil"));
...
function ViewAllExplorer(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_NavHeader.default, {
    ...
    data: _DataUtil.default.getAllWallets({
      search
    }),
    style: {
      height: Math.round(windowHeight * 0.6)
    ...
    getItemLayout: (_data, index) => ({
      length: _WalletItem.ITEM_HEIGHT,
      offset: _WalletItem.ITEM_HEIGHT * index,
      index
    }),
    renderItem: _ref2 => {
      let {
